...
# detach; retain_graph=False; requires_grad=False for Disc
...
det_discriminator = dict(type='Conv2dDiscriminator', in_dim=128)
seg_optimizer = dict(type='SGD', lr=0.001, momentum=0.9, weight_decay=0.005)
det_optimizer = dict(type='SGD', lr=0.001, momentum=0.9, weight_decay=0.005)

# shedule_2x.py
runner = 'DiscRunner' + runner_ver
