##############################################
# variants: Runner, model, lambda, Discriminators
# options: train-test split; class_weights
##############################################
runner = 'ImgDiscRunner01'
model_type = 'FusionDisc02'  # return img_feats before fusion
lambda_GANLoss = 0.0001

seg_discriminator = dict(type='ConvDiscriminator1x1', in_dim=64, activation='Leaky')
seg_optimizer = dict(type='Adam', lr=0.0002, weight_decay=0.001)
det_discriminator = None
det_optimizer = None

src_train = 'mmda_xmuda_split/train_day.pkl'
tgt_train = 'mmda_xmuda_split/train_night.pkl'
...
class_weights = daynight_weights
