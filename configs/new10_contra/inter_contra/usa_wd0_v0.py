...
# 32 epochs; wd=0; temperature=1.0; SegFusionContra
...
model_type = 'SegFusionContra'
img_dim, pts_dim = 64, 16
prelogits_dim = img_dim + pts_dim
contra_img_dim, contra_pts_dim = 64, 32
contrast_dict = dict(
    contrast_criterion=dict(type='NT_Xent', temperature=1.0, normalize=True, contrast_mode='cross_entropy'),
    lambda_contrast=0.03,
    max_pts=100000,
    groups=1,
    img_fcs=(contra_img_dim, contra_pts_dim),
    pts_fcs=(contra_pts_dim, contra_pts_dim)
)
