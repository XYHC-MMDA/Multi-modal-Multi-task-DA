# finetune without freezing; pretrain model: v2/epoch_32.pth
# epochs=32; weight_decay=1e-4; model=SegFusionV4
...
# load_from
load_from = './checkpoints/fusion_consis/pretrain/contrast_usa_pretrain_v2/epoch_32.pth'

##########################
# optimizer & lr_scheduler
###########################
optimizer = dict(type='Adam', lr=0.001, weight_decay=1e-4)
lr_step = [16, 24]  # init lr is half the lr of pretrain(0.001)
total_epochs = 32
