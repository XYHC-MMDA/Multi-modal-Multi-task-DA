...
runner_ver = '06_2'
model_ver = '01'  # return (N, 128, 200, 400) for det
seg_disc, seg_in = 'FCDiscriminatorCE', 128
det_disc, det_in = 'Conv2dDiscriminator01', 128
...
# discriminators
seg_discriminator = dict(type=seg_disc, in_dim=seg_in)
det_discriminator = dict(type=det_disc, in_dim=det_in)
seg_optimizer = dict(type='Adam', lr=0.0002, weight_decay=0.001)
det_optimizer = dict(type='Adam', lr=0.0002, weight_decay=0.001)
