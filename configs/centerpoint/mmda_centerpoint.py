...
point_cloud_range = [-54, 0, -5.0, 54, 54, 3.0]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=[-61.2, 0, -10.0, 61.2, 61.2, 10.0],
            max_num=500,
            score_threshold=0.1,
            out_size_factor=8,
