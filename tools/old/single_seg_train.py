...
from mmdet3d.apis import set_random_seed, train_single_seg_detector
...
def main():
    ...
    train_single_seg_detector(model, datasets, cfg, distributed=distributed, timestamp=timestamp, meta=meta)
