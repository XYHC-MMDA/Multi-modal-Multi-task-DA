...
from mmdet3d.apis import set_random_seed, train_general_detector
...
def main():
    ...
    train_general_detector(model, datasets, cfg, distributed=distributed, timestamp=timestamp, meta=meta)
