...
class ContrastRunnerV2(BaseRunner):
    def __init__(self,
                 model,
                 cfg,
                 ...
                 max_iters=None,
                 max_epochs=None):
        super(ContrastRunnerV2, self).__init__(model,
                                                 batch_processor,
                                                 optimizer,
                                                 work_dir,
                                                 logger,
    ...
    def train(self, src_data_loader, tgt_data_loader):
        ...
        for i, src_data_batch in enumerate(self.data_loader):
            ...
            # ------------------------
            src_losses = self.model(**src_data_batch, target=True)
            tgt_losses = self.model(**tgt_data_batch, target=True)
