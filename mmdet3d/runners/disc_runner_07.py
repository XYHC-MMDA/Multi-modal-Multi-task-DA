...
class DiscRunner07(BaseRunner):
    def __init__(self,
                 ...
                 max_iters=None,
                 max_epochs=None):
        super(DiscRunner07, self).__init__(model,
                                           batch_processor,
                                           optimizer,
                                           work_dir,
                                           logger,
    ...
    def train(self, src_data_loader, tgt_data_loader):
        ...
        for i, src_data_batch in enumerate(self.data_loader):
            ...
            # only forward once; for both disc use and network use
            ...
            log_vars['seg_Dloss'] = log_seg_Dloss
            log_vars['det_Dloss'] = log_det_Dloss
