...
class SepBaseline(Base3DDetector):
    def __init__(self,
                 ...
                 pretrained=None,
                 vfes=[]):
        super(SepBaseline, self).__init__()
    ...
    def extract_det_feat(self, pts, pts_feats, img_metas):
        '''
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        det_feats = self.extract_det_feat(points, pts_feats, img_feats)  # output of FPN
    ...
    def forward_train(self,
        ...
        Returns: losses
        '''
        img_feats, det_feats = self.extract_feat(points, img, img_metas)
    ...
    def init_weights(self, pretrained=None):
        ...
        super(SepBaseline, self).init_weights(pretrained)
