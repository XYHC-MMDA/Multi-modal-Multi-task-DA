...
class MultiTaskSep(Base3DDetector):
    def __init__(self,
    ...
    def extract_feat(self, points, pts_indices, img, img_metas, seg_pts_indices):
    ...
    def forward_train(self,
        ...
        sample_feats, pts_feats = self.extract_feat(points, pts_indices, img, img_metas, seg_pts_indices)

        losses = dict()
        # seg_loss
        seg_logits = self.img_seg_head.head(sample_feats)
        losses_img = self.img_seg_head.loss(seg_logits, seg_label)
        losses.update(losses_img)

        # det_loss; pts_feats: tuple
    ...
    def init_weights(self, pretrained=None):
        ...
        super(MultiTaskSep, self).init_weights(pretrained)
