...
class Single2D3D(Base3DDetector):
    def __init__(self,
                 img_backbone=None,
                 pts_backbone=None,
                 num_classes=None,
                 ...
                 train_cfg=None,
                 test_cfg=None):
        super(Single2D3D, self).__init__()
    ...
    def forward_train(self,
        ...
        # sample_feats: list of (N_i, 64) or None; pts_feats: list of (N_i, 16) or None
    ...
    def init_weights(self, pretrained=None):
        ...
        super(Single2D3D, self).init_weights(pretrained)
