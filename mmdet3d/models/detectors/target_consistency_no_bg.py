...
class TargetConsistencyNoBG(Base3DDetector):
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TargetConsistencyNoBG, self).__init__()
    ...
    def forward_target(self,
        ...
        target_seg_loss = self.img_seg_head.loss(seg_logits, fake_labels, ignore_background=True)  # cross_entropy
    ...
    def init_weights(self, pretrained=None):
        ...
        super(TargetConsistencyNoBG, self).init_weights(pretrained)
